...
def enrich_element_type(client, el_type, el_name, props, type_cache):
    ...
    prompt = f"""You are a UK BIM COBie data enrichment engine.
...
def enrich_all(elements, api_key, progress_callback=None):
    ...
    for i, el_type in enumerate(unique_types):
        ...
        data = enrich_element_type(client, el_type, rep["name"], rep.get("props", {}), type_cache)
