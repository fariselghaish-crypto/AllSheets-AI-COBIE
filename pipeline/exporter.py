...
COLOURS = {
    ...
    "external_source": "D9EAF7",  # Light blue for external-source fields
}
...
REQUIRED_FIELDS = {
    ...
    "Coordinate": ["Name", "CreatedBy", "CreatedOn", "SheetName", "RowName"],
    "Attribute":  ["Name", "CreatedBy", "CreatedOn", "SheetName", "RowName", "Value"],
    "Connection": ["Name", "CreatedBy", "CreatedOn", "SheetName", "RowName1", "RowName2"],
    "Issue":      ["Name", "CreatedBy", "CreatedOn", "SheetName", "RowName", "Risk"],
}
...
def _write_sheet(wb: Workbook, sheet_name: str, df: pd.DataFrame):
    ...
    for ri, (_, row) in enumerate(df.iterrows(), start=2):
        ...
        for ci, col in enumerate(cols, start=1):
            ...
            required = REQUIRED_FIELDS.get(sheet_name, [])
            if "External source required" in sval:
                cell.fill = PatternFill("solid", fgColor=COLOURS["external_source"])
            elif col in required and sval in ("TBC", ""):
